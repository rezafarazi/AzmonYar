...
public class Form_table extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("تعداد دانش آموز");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        database.login.Class_db.Delete_one(ID);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        database.login.Class_db.Edit(jTextField1.getText().toString(), Integer.parseInt(jTextField2.getText().toString()), ID);
        dbms();
        clear();
    ...
    public void grap()
    {
       ...
       dbms();
        ...
        try
        {
            ...
            InputStream is = Form_table.class.getResourceAsStream("s.ttf");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_table.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
